...
Matrix<double, 10, 2> matchFeatures( Matrix<double, 10, 2> featurepoints_lastimage,  Matrix<double, 10, 2>featurepoints_currentimage )
{
  ...
  Eigen::Matrix<int, 5, 2> matchedpair; // 第二个参数填为5,作为测试
  ...
  {
    int x =    (i,0); // x, y of the featurepoints
