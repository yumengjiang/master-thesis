...
Matrix<double, 10, 2> matchFeatures( Matrix<double, Dynamic, 2> featurepoints_lastimage,  Matrix<double, Dynamic, 2>featurepoints_currentimage )
{
  ...
  Eigen::Matrix<int, featsize_last_row, 2> matchedpair; // 第二个参数填为5,作为测试
